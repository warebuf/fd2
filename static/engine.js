...
function drawStarters() {
    if((state!=null) && (my_team != -1) && (my_int != -1)) {
        ...
        for(let i = 0; i < state[my_team][my_int].length; i++) {
            ...
            ctx.fillStyle = 'red';
            ctx.textAlign = "left";
            ctx.fillRect(15,90 + (60*i), 1, 55);
            ctx.fillRect(15,90 + (60*i), 5, 1);
            ctx.fillRect(15,90 + 55 + (60*i), 5, 1);

            // right bracket
            ctx.fillStyle = 'red';
            ctx.textAlign = "left";
            ctx.fillRect(150 + x_offset_4,90 + (60*i), 1, 55);
            ctx.fillRect(150 + x_offset_4,90 + (60*i), 5, 1);
            ctx.fillRect(150 + x_offset_4,90 + 55 + (60*i), 5, 1);
            ...
            ctx.fillText(MOB,x*2 + x_offset_3, y1+ 120 + (60*i));
            ctx.fillText(CD,x*0 + x_offset_3, y1+ 130 + (60*i));
            ctx.fillText(CLU,x*1 + x_offset_3, y1+ 130 + (60*i));
            ...
            ctx.fillText(MOB,x*2 + x_offset_4, y1+ 120 + (60*i));
            ctx.fillText(CD,x*0 + x_offset_4, y1+ 130 + (60*i));
            ctx.fillText(CLU,x*1 + x_offset_4, y1+ 130 + (60*i));
