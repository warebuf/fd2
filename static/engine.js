        ...
        for (let j=0;j<(state.length);j++) {
            for (let k=0;k<(state[j].length);k++) {
                for (let i=0;i<(state[j][k].length);i++){
                    ...
                    ctx.fillText("HP",x_offset-25+(user_shift*user_count), y_offset+25 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ...
                    ctx.fillText("ATK",x_offset+25+(user_shift*user_count), y_offset+25 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ...
                    ctx.fillText("DEF",x_offset+75+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillText("ACC",x_offset+125+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillText("CRT",x_offset+175+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillText("CD",x_offset+225+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillText("CLU",x_offset+275+(user_shift*user_count), y_offset+15 + (i*unit_shift) )

                    ctx.fillRect(x_offset-2+380+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].H.Weight/2);
                    ctx.fillRect(x_offset-2+395+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].L.Weight/2);
                    ctx.fillRect(x_offset-2+410+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].R.Weight/2);
                    ctx.fillRect(x_offset-2+425+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].B.Weight/2);
                    ctx.fillText("WGT",x_offset+325+(user_shift*user_count), y_offset+15 + (i*unit_shift) )

                    ctx.fillRect(x_offset-2+440+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.SPD/2) + (i*unit_shift),4,0 | state[j][k][i].B.SPD/2);
                    ctx.fillText("SPD",x_offset+375+(user_shift*user_count), y_offset+15 + (i*unit_shift) )

                    ctx.fillRect(x_offset-2+455+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.DOG/2) + (i*unit_shift),4,0 | state[j][k][i].B.DOG/2);
