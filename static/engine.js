    ...
    for(let i = 0; i < state.length; i++) {
        for(let j = 0; j < state[i].length; j++) {
            for(let k = 0; k < state[i][j].length; k++) {
                ...
                if(i%2==0) {
                    ctx.fillRect(700+(270*i),400+(k*120)+(j*700),260,1);
                    ctx.fillText('o', 700+(270*i), 400+(k*120)+(j*700) );
                    ctx.fillText('x', 700+(270*i)+260, 400+(k*120)+(j*700) );
                } else {
                    ctx.fillRect(700+(270*i),400+(k*120)+(j*700),260,1);
                    ctx.fillText('x', 700+(270*i)-5, 400+(k*120)+(j*700) );
                    ctx.fillText('o', 700+(270*i)+260, 400+(k*120)+(j*700) );
                }
