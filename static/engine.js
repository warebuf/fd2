        ...
        for(let j = 0; j < state[i].length; j++) {
            for(let k = 0; k < state[i][j].length; k++) {
                ...
                if(i%2==0) {
                    ...
                    ctx.fillText(temp, 700+(270*i)+(250*(state[i][j][k].Position/100)), 400+(k*120)+(j*700)-20);
                    ctx.textAlign = "left";
                } else {
                    if(symbol=='>'){symbol='<'}
                    ...
                    ctx.fillText(temp, 700+(270*i)+250-(250*(state[i][j][k].Position/100))-5, 400+(k*120)+(j*700)-20);
                    ctx.textAlign = "left";
                }
