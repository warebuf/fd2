        ...
        for (let j=0;j<(state.length);j++) {
            for (let k=0;k<(state[j].length);k++) {
                for (let i=0;i<(state[j][k].length);i++){
                    ctx.textAlign = "center";
                    ctx.fillRect(x_offset-45+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.HP/2) + (i*unit_shift),4,0 | state[j][k][i].H.HP/2);
                    ctx.fillRect(x_offset-30+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.HP/2) + (i*unit_shift),4,0 | state[j][k][i].L.HP/2);
                    ctx.fillRect(x_offset-15+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.HP/2) + (i*unit_shift),4,0 | state[j][k][i].R.HP/2);
                    ctx.fillRect(x_offset-0+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.HP/2) + (i*unit_shift),4,0 | state[j][k][i].B.HP/2);
                    ...
                    ctx.fillRect(x_offset+25+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.ATK/2) + (i*unit_shift),4,0 | state[j][k][i].H.ATK/2);
                    ctx.fillRect(x_offset+40+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.ATK/2) + (i*unit_shift),4,0 | state[j][k][i].L.ATK/2);
                    ctx.fillRect(x_offset+55+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.ATK/2) + (i*unit_shift),4,0 | state[j][k][i].R.ATK/2);
                    ctx.fillRect(x_offset+70+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.ATK/2) + (i*unit_shift),4,0 | state[j][k][i].B.ATK/2);
                    ...
                    ctx.fillRect(x_offset+95+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.DEF/2) + (i*unit_shift),4,0 | state[j][k][i].H.DEF/2);
                    ctx.fillRect(x_offset+110+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.DEF/2) + (i*unit_shift),4,0 | state[j][k][i].L.DEF/2);
                    ctx.fillRect(x_offset+125+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.DEF/2) + (i*unit_shift),4,0 | state[j][k][i].R.DEF/2);
                    ctx.fillRect(x_offset+140+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.DEF/2) + (i*unit_shift),4,0 | state[j][k][i].B.DEF/2);
                    ...
                    ctx.fillText(state[j][k][i].L.DEF,x_offset+110+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].R.DEF,x_offset+125+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].B.DEF,x_offset+140+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.font = '11px monospace';

                    ctx.fillRect(x_offset+165+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.ACC/2) + (i*unit_shift),4,0 | state[j][k][i].H.ACC/2);
                    ctx.fillRect(x_offset+180+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.ACC/2) + (i*unit_shift),4,0 | state[j][k][i].L.ACC/2);
                    ctx.fillRect(x_offset+195+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.ACC/2) + (i*unit_shift),4,0 | state[j][k][i].R.ACC/2);
                    ctx.fillRect(x_offset+210+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.ACC/2) + (i*unit_shift),4,0 | state[j][k][i].B.ACC/2);
                    ...
                    ctx.fillText(state[j][k][i].L.ACC,x_offset+180+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].R.ACC,x_offset+195+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].B.ACC,x_offset+210+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.font = '11px monospace';

                    ctx.fillRect(x_offset+235+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.CRT/2) + (i*unit_shift),4,0 | state[j][k][i].H.CRT/2);
                    ctx.fillRect(x_offset+250+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.CRT/2) + (i*unit_shift),4,0 | state[j][k][i].L.CRT/2);
                    ctx.fillRect(x_offset+265+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.CRT/2) + (i*unit_shift),4,0 | state[j][k][i].R.CRT/2);
                    ctx.fillRect(x_offset+280+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.CRT/2) + (i*unit_shift),4,0 | state[j][k][i].B.CRT/2);
                    ctx.fillText("CRT",x_offset+257.5+(user_shift*user_count), y_offset+25 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ctx.fillText(state[j][k][i].H.CRT,x_offset+235+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].L.CRT,x_offset+250+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].R.CRT,x_offset+265+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].B.CRT,x_offset+280+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.font = '11px monospace';

                    ctx.fillRect(x_offset+305+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.CD/2) + (i*unit_shift),4,0 | state[j][k][i].H.CD/2);
                    ctx.fillRect(x_offset+320+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.CD/2) + (i*unit_shift),4,0 | state[j][k][i].L.CD/2);
                    ctx.fillRect(x_offset+335+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.CD/2) + (i*unit_shift),4,0 | state[j][k][i].R.CD/2);
                    ctx.fillRect(x_offset+350+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.CD/2) + (i*unit_shift),4,0 | state[j][k][i].B.CD/2);
                    ctx.fillText("CD",x_offset+327.5+(user_shift*user_count), y_offset+25 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ctx.fillText(state[j][k][i].H.CD,x_offset+305+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].L.CD,x_offset+320+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].R.CD,x_offset+335+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.fillText(state[j][k][i].B.CD,x_offset+350+(user_shift*user_count), y_offset+10 + (i*unit_shift) )
                    ctx.font = '11px monospace';

                    ctx.fillRect(x_offset+375+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.CLU/2) + (i*unit_shift),4,0 | state[j][k][i].H.CLU/2);
                    ctx.fillRect(x_offset+390+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.CLU/2) + (i*unit_shift),4,0 | state[j][k][i].L.CLU/2);
                    ctx.fillRect(x_offset+405+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.CLU/2) + (i*unit_shift),4,0 | state[j][k][i].R.CLU/2);
                    ctx.fillRect(x_offset+420+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.CLU/2) + (i*unit_shift),4,0 | state[j][k][i].B.CLU/2);
                    ...
                    ctx.fillRect(x_offset+445+(user_shift*user_count),y_offset - (0 | state[j][k][i].H.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].H.Weight/2);
                    ctx.fillRect(x_offset+460+(user_shift*user_count),y_offset - (0 | state[j][k][i].L.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].L.Weight/2);
                    ctx.fillRect(x_offset+475+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].R.Weight/2);
                    ctx.fillRect(x_offset+490+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].B.Weight/2);
                    ...
                    ctx.fillRect(x_offset+515+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.SPD/2) + (i*unit_shift),4,0 | state[j][k][i].B.SPD/2);
                    ...
                    ctx.fillRect(x_offset+540+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.DOG/2) + (i*unit_shift),4,0 | state[j][k][i].B.DOG/2);
