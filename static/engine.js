    ...
    for(let i = 0; i < match_data[current_state].length; i++) {
        for(let j = 0; j < match_data[current_state][i].length; j++) {
            for(let k = 0; k < match_data[current_state][i][j].length; k++) {
                ...
                ctx.fillText("100", 125, ((i+j)*115) + 82 + (k*20)) // H ATK
                ctx.fillText("100", 130, ((i+j)*115) + 82 + (k*20)) // H DEF
                ctx.fillText("100", 135, ((i+j)*115) + 82 + (k*20)) // H ACC
                ctx.fillText("100", 140, ((i+j)*115) + 82 + (k*20)) // H CRIT
                ctx.fillText("100", 145, ((i+j)*115) + 82 + (k*20)) // H MOBI
                ctx.fillText("100", 150, ((i+j)*115) + 82 + (k*20)) // H CD
                ctx.fillText("100", 155, ((i+j)*115) + 82 + (k*20)) // H CLU
                ctx.fillText("0/0", 160, ((i+j)*115) + 82 + (k*20)) // H USE
                ctx.fillText("100", 165, ((i+j)*115) + 82 + (k*20)) // H WEIGHT
