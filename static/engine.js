        ...
        for (let j=0;j<(state.length);j++) {
            for (let k=0;k<(state[j].length);k++) {
                for (let i=0;i<(state[j][k].length);i++){
                    ...
                    ctx.fillText("DEF",x_offset+100+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillText("ACC",x_offset+160+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillText("CRT",x_offset+220+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillText("CD",x_offset+280+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillText("CLU",x_offset+340+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
                    ...
                    ctx.fillRect(x_offset-2+415+(user_shift*user_count),y_offset - (0 | state[j][k][i].R.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].R.Weight/2);
                    ctx.fillRect(x_offset-2+430+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.Weight/2) + (i*unit_shift),4,0 | state[j][k][i].B.Weight/2);
                    ctx.fillText("WGT",x_offset+400+(user_shift*user_count), y_offset+15 + (i*unit_shift) )

                    ctx.fillRect(x_offset-2+455+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.SPD/2) + (i*unit_shift),4,0 | state[j][k][i].B.SPD/2);
                    ctx.fillText("SPD",x_offset+455+(user_shift*user_count), y_offset+15 + (i*unit_shift) )

                    ctx.fillRect(x_offset-2+470+(user_shift*user_count),y_offset - (0 | state[j][k][i].B.DOG/2) + (i*unit_shift),4,0 | state[j][k][i].B.DOG/2);
                    ctx.fillText("DOG",x_offset+470+(user_shift*user_count), y_offset+15 + (i*unit_shift) )
