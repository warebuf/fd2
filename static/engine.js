        ...
        for(let j = 0; j < state[i].length; j++) {
            for(let k = 0; k < state[i][j].length; k++) {
                ...
                if(state[i][j][k].H.HP>0) {
                    ...
                    if (state[i][j][k].L.HP > 0) {
                        ctx.fillText((0|(100*state[i][j][k].L.Weight/total_prob))+"%", x0-10+(space*i)-10,  y0-4 + (k*120)+(j*700) +5 + 10 );
                    ...
                    if (state[i][j][k].B.HP > 0) {
                        ctx.fillText((0|(100*state[i][j][k].B.Weight/total_prob))+"%", x0+(space*i)+2-5-10,  y0+8 + (k*120)+(j*700)+10 );
