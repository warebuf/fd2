        ...
        */
        ...
        for(let i = 0; i < atk_data[animating_state].length; i++) { // iterate through all attacks
            ...
            for(let j = 0 ; j < atk_json_obj.Damage.length; j++) { //
                ...
                let hperc = Math.round(100*hw/(hw+lw+rw+bw))/100
                let lperc = Math.round(100*lw/(hw+lw+rw+bw))/100
                let rperc = Math.round(100*rw/(hw+lw+rw+bw))/100
                let bperc = Math.round(100*bw/(hw+lw+rw+bw))/100
