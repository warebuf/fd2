    ...
    for(let i = 0; i < state.length; i++) {
        for(let j = 0; j < state[i].length; j++) {
            for(let k = 0; k < state[i][j].length; k++) {
                ...
                if(i%2==0) {
                    ctx.fillRect(700+(150*i),400+(k*20)+((i+j)*60),100,1);
                    ctx.fillText('o', 700+(150*i), 400+(k*20)+((i+j)*60) );
                    ctx.fillText('x', 700+(150*i)+100, 400+(k*20)+((i+j)*60) );
                } else {
                    ctx.fillRect(700+(150*i),400+(k*20)+((i+j)*60),100,1);
                    ctx.fillText('x', 700+(150*i)-5, 400+(k*20)+((i+j)*60) );
                    ctx.fillText('o', 700+(150*i)+100, 400+(k*20)+((i+j)*60) );
                }
