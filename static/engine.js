        ...
        for (let j=0;j<(state.length);j++) {
            for (let k=0;k<(state[j].length);k++) {
                for (let i=0;i<(state[j][k].length);i++){
                    ...
                    ctx.fillText("HP",x_offset-22.5+(user_shift*user_count), y_offset-60 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ...
                    ctx.fillText("H",x_offset-45+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("L",x_offset-30+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("R",x_offset-15+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("B",x_offset-0+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.font = '11px monospace';
                    ...
                    ctx.fillText("ATK",x_offset+47.5+(user_shift*user_count), y_offset-60 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ...
                    ctx.fillText("DEF",x_offset+117.5+(user_shift*user_count), y_offset+35 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ...
                    ctx.fillText("H",x_offset+95+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("L",x_offset+110+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("R",x_offset+125+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("B",x_offset+140+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.font = '11px monospace';
                    ...
                    ctx.fillText("ACC",x_offset+187.5+(user_shift*user_count), y_offset+35 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ...
                    ctx.fillText("H",x_offset+165+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("L",x_offset+180+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("R",x_offset+195+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("B",x_offset+210+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.font = '11px monospace';
                    ...
                    ctx.fillText("CRT",x_offset+257.5+(user_shift*user_count), y_offset+35 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ...
                    ctx.fillText("H",x_offset+235+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("L",x_offset+250+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("R",x_offset+265+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("B",x_offset+280+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.font = '11px monospace';
                    ...
                    ctx.fillText("CD",x_offset+327.5+(user_shift*user_count), y_offset+35 + (i*unit_shift) )
                    ctx.font = '9px monospace';
                    ...
                    ctx.fillText("H",x_offset+305+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("L",x_offset+320+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("R",x_offset+335+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.fillText("B",x_offset+350+(user_shift*user_count), y_offset+20 + (i*unit_shift) )
                    ctx.font = '11px monospace';
