...
function drawStats() {
    ...
    ctx.fillText("T C H", 25, 60);
    ctx.fillText("HP", 65, 60);
    ctx.fillText("D POS ACT", 85, 60);

    ctx.fillText("H HP ATK DEF ACC CRIT MOBI CD CLU USE WEI", 150, 60);
    ctx.fillText("L HP ATK DEF ACC CRIT MOBI CD CLU USE WEI", 300, 60);
    ctx.fillText("R HP ATK DEF ACC CRIT MOBI CD CLU USE WEI", 500, 60);
    ctx.fillText("B HP DEF DOG SPD ACCL ANTI END WEI", 600, 60);
