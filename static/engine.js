...
function drawTable1() {
    if((state!=null) && (my_team != -1) && (my_int != -1)) {
        ...
        ctx.fillStyle = 'blue';
        ctx.fillRect(x_offset+110,y_offset+12,ctx.measureText(state[my_team][my_int][0].H.NAME).width,ctx.measureText('M').width);
        ctx.fillStyle = 'white';
        ctx.fillText(state[my_team][my_int][0].H.NAME,x_offset+110, y_offset+20 )
        ctx.fillText("A basic close attack.",x_offset+110, y_offset+30 )
        ...
        ctx.fillStyle = 'blue';
        ctx.fillRect(x_offset+110,y_offset+62,ctx.measureText(state[my_team][my_int][0].L.NAME).width,ctx.measureText('M').width);
        ctx.fillStyle = 'white';
        ctx.fillText(state[my_team][my_int][0].L.NAME,x_offset+110, y_offset+70 )
        ctx.fillText("A basic close attack.",x_offset+110, y_offset+80 )
        ...
        ctx.fillStyle = 'blue';
        ctx.fillRect(x_offset+110,y_offset+112,ctx.measureText(state[my_team][my_int][0].R.NAME).width,ctx.measureText('M').width);
        ctx.fillStyle = 'white';
        ctx.fillText(state[my_team][my_int][0].R.NAME,x_offset+110, y_offset+120 )
        ctx.fillText("A basic close attack.",x_offset+110, y_offset+130 )
        ...
        ctx.fillStyle = 'blue';
        ctx.fillRect(x_offset+110,y_offset+162,ctx.measureText(state[my_team][my_int][0].B.NAME).width,ctx.measureText('M').width);
        ctx.fillStyle = 'white';
        ctx.fillText(state[my_team][my_int][0].B.NAME,x_offset+110, y_offset+170 )
        ctx.fillText("A basic close attack.",x_offset+110, y_offset+180 )
